...
============================================================================
自チャンピオンの分類（SPLIT/PICKOFF/TURTLE）と時間帯・ゴールド差から、逆転ルートの
方針を3種類の定型アドバイスから選択して提示する。

⚠️ 2026-09-22訂正: 以前このdocstringは「定型文を廃止し…リアルタイムに動的判定」と
記載していたが、実体は3つの定型文の選択であり、チャンピオン分類も手書きの29体分のみ
（未登録は全て TURTLE_TEAMFIGHT 扱い）。内容は一般論の範囲だが、「動的判定」という
表現は実態と異なるため訂正した。
"""
