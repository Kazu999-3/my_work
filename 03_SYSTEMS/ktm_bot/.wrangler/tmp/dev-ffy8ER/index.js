...
// .wrangler/tmp/bundle-FTZh6G/checked-fetch.js
...
// .wrangler/tmp/bundle-FTZh6G/strip-cf-connecting-ip-header.js
...
${metadata.memo ? "\u{1F4AC} **\u30E1\u30E2**: " + metadata.memo : ""}`.trim();
}
...
// .wrangler/tmp/bundle-FTZh6G/middleware-loader.entry.ts
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();

// .wrangler/tmp/bundle-FTZh6G/middleware-insertion-facade.js
init_checked_fetch();
init_strip_cf_connecting_ip_header();
init_modules_watch_stub();
...
async function handleButtonInteraction(interaction, env, ctx) {
  ...
  if (customId.startsWith("win_blue:") || customId.startsWith("win_red:")) {
    const ownerId = customId.split(":")[1];
    if (userId !== ownerId && userId !== CONFIG.ADMIN_ID)
      return Response.json({ type: 4, data: { content: "\u26A0\uFE0F \u5B9F\u884C\u3057\u305F\u672C\u4EBA\u306E\u307F\u5831\u544A\u53EF\u80FD\u3067\u3059\u3002", flags: 64 } });
