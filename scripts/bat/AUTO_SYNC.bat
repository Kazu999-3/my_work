...
python ..\..\apps\intelligence\trend_watcher.py >> ..\..\02_research\reports\auto_sync.log 2>&1
python ..\hybrid_bot\src\trends_analyzer.py >> ..\..\02_research\reports\auto_sync.log 2>&1
