    ...
    def cargo_pull_all(self):
        ...
        for page in results:
            ...
            if category == "Foundation":
                if file_name == "ANTIGRAVITY.md": target_path = ROOT_DIR / "ANTIGRAVITY.md"
                else: target_path = ROOT_DIR / "01_foundation" / file_name
            elif category == "Report":
                target_path = ROOT_DIR / "02_research" / "reports" / file_name
            elif category == "Draft":
                target_path = ROOT_DIR / "03_social" / "daily_posts" / file_name
...
def full_initial_ship():
    ...
    # Foundation
    syncer.ship_file(ROOT_DIR / "ANTIGRAVITY.md", "Foundation")
    ...
    # Drafts
    for f in (ROOT_DIR / "03_social" / "daily_posts").glob("*.md"):
