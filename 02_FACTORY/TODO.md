...
## ✅ 2026-09-25 対応済み（Sovereign HUD オーバーレイ総合整理）
...
- [x] **休眠ウィジェット接続**: `LaneDominanceWidget`（スコアボード行別ゴールド差）をTABキー連動に正式配備
- [x] **内部パス修正＆全テスト合格**: `run_demo.bat` / `run_tests.bat` のパス修正、全自動テストスイート18件全パス（OK）
