...
const GENERAL_MENU_ITEMS: MenuItem[] = [
  ...
  // 攻略・コーチ
  { id: 'champions', label: 'チャンピオン攻略辞典', shortLabel: '攻略辞典', icon: BookHeart, href: '/champions', color: 'text-amber-600', activeBg: 'bg-amber-500/15', section: '攻略 ＆ コーチ' },
  { id: 'coach', label: 'パーソナルコーチ', shortLabel: 'コーチ', icon: Sparkles, href: '/coach', color: 'text-purple-600', activeBg: 'bg-purple-500/15', section: '攻略 ＆ コーチ' },
  // ガイド
