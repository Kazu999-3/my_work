...
指示:
- 【🚨 2026年シーズン最新仕様の厳格適用】記事内に過去パッチの古い記述（3:30スカトル、14:00プレート消滅等）があっても、必ず【2026年最新仕様（キャンプ0:55、スカトル2:55、ドラゴン5:00、グラブ8:00、ヘラルド15:00、バロン20:00、タワープレート永続）】に自動補正して統合してください。
