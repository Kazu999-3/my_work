...
import { Edit3, Save, X, RefreshCw, CheckCircle, AlertTriangle } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center bg-[#0f111a]/60 backdrop-blur-md border border-white/10 rounded-2xl p-4 md:px-8 shadow-xl gap-4">
        <div>
          <h2 className="text-lg font-black text-transparent bg-clip-text bg-gradient-to-r from-[#c89b3c] to-yellow-200">
      ...
      {/* コンテンツ領域 */}
      <div className="bg-[#0f111a]/40 backdrop-blur-md rounded-3xl border border-white/10 p-6 md:p-12 shadow-2xl">
        {!isEditing ? (
          // プレビュー表示モード
          <ReactMarkdown
