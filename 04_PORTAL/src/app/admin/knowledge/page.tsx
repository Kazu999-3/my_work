...
import { Brain, Search, Plus, Trash2, Calendar, Link as LinkIcon, RefreshCw, FileText, ChevronDown, ChevronUp, BookOpen, Layers, Sparkles, Tag } from 'lucide-react';
        ...
        <form onSubmit={handleAddKnowledge} className="space-y-4">
          {inputType === 'url' ? (
            <div className="flex flex-col md:flex-row gap-4">
              <input
                type="url"
                placeholder="https://example.com/lol-guide"
                value={inputUrl}
