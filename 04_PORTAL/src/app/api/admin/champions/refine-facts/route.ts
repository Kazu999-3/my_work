...
【🚨 完全日本語化・英語表記の徹底排除ルール（絶対厳守）】
元データに英語のアイテム名、ルーン名、チャンピオン名、スキル名、ゲーム用語が含まれていても、**清書後の文章では英語表記を一切使わず、必ず「公式日本語名称」に変換して出力**してください。
- ❌ 英語NG例: Infinity Edge, Black Cleaver, Conqueror, Flash, Smite, Ult, Sustain, Snowball, Teamfight
- ⭕ 日本語OK例: インフィニティ エッジ、ブラック クリーバー、征服者、フラッシュ、スマイト、アルティメット(R)、サステイン、スノーボール、集団戦
- チャンピオン名も英語（例: Viktor, Syndra, Ahri）ではなくカタカナ（ビクター、シンドラ、アーリ）で記述してください。
