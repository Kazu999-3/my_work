...
const KTM_TIERS = [
  { name: 'CHALLENGER', min: 1900, color: 'text-sky-300', bg: 'bg-sky-300/10' },
  { name: 'GRANDMASTER', min: 1800, color: 'text-red-500', bg: 'bg-red-500/10' },
  { name: 'MASTER', min: 1700, color: 'text-purple-500', bg: 'bg-purple-500/10' },
  { name: 'DIAMOND I', min: 1675, color: 'text-blue-400', bg: 'bg-blue-400/10' },
  { name: 'DIAMOND II', min: 1650, color: 'text-blue-400', bg: 'bg-blue-400/10' },
  { name: 'DIAMOND III', min: 1625, color: 'text-blue-400', bg: 'bg-blue-400/10' },
  { name: 'DIAMOND IV', min: 1600, color: 'text-blue-400', bg: 'bg-blue-400/10' },
  { name: 'EMERALD I', min: 1575, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
  { name: 'EMERALD II', min: 1550, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
  { name: 'EMERALD III', min: 1525, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
  { name: 'EMERALD IV', min: 1500, color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
  { name: 'PLATINUM I', min: 1485, color: 'text-teal-400', bg: 'bg-teal-400/10' },
  { name: 'PLATINUM II', min: 1470, color: 'text-teal-400', bg: 'bg-teal-400/10' },
  { name: 'PLATINUM III', min: 1460, color: 'text-teal-400', bg: 'bg-teal-400/10' },
  { name: 'PLATINUM IV', min: 1450, color: 'text-teal-400', bg: 'bg-teal-400/10' },
  { name: 'GOLD I', min: 1410, color: 'text-yellow-400', bg: 'bg-yellow-400/10' },
  { name: 'GOLD II', min: 1370, color: 'text-yellow-400', bg: 'bg-yellow-400/10' },
  { name: 'GOLD III', min: 1330, color: 'text-yellow-400', bg: 'bg-yellow-400/10' },
  { name: 'GOLD IV', min: 1300, color: 'text-yellow-400', bg: 'bg-yellow-400/10' },
  { name: 'SILVER I', min: 1260, color: 'text-slate-300', bg: 'bg-slate-300/10' },
  { name: 'SILVER II', min: 1220, color: 'text-slate-300', bg: 'bg-slate-300/10' },
  { name: 'SILVER III', min: 1180, color: 'text-slate-300', bg: 'bg-slate-300/10' },
  { name: 'SILVER IV', min: 1150, color: 'text-slate-300', bg: 'bg-slate-300/10' },
  { name: 'BRONZE I', min: 1110, color: 'text-amber-700', bg: 'bg-amber-700/10' },
  { name: 'BRONZE II', min: 1070, color: 'text-amber-700', bg: 'bg-amber-700/10' },
  { name: 'BRONZE III', min: 1040, color: 'text-amber-700', bg: 'bg-amber-700/10' },
  { name: 'BRONZE IV', min: 1000, color: 'text-amber-700', bg: 'bg-amber-700/10' },
  { name: 'IRON I', min: 960, color: 'text-gray-500', bg: 'bg-gray-500/10' },
  { name: 'IRON II', min: 920, color: 'text-gray-500', bg: 'bg-gray-500/10' },
  { name: 'IRON III', min: 880, color: 'text-gray-500', bg: 'bg-gray-500/10' },
  { name: 'IRON IV', min: 840, color: 'text-gray-500', bg: 'bg-gray-500/10' },
