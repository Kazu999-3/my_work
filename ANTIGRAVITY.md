...
- [ ] **[フェーズ13]** コーチ ✕ 辞典 ✕ バトルリサーチ 4ステップ完全統合
  - [ ] **[ステップ1]** 試合進行に応じた4タブUI構造（①BAN/PICK, ②試合前, ③試合後振り返り, ④辞典&バトルリサーチ）への全面整理統合
  - [ ] **[ステップ2]** 試合選択カードへの「✅ 振り返り完了」/「⚠️ 未振り返り」ステータスバッジの明確表示
  - [ ] **[ステップ3]** 「📊 マイソロQダッシュボード」（過去の振り返りログ・勝率・メンタル推移・対面メモ履歴の一覧ビュー）の実装
  - [ ] **[ステップ4]** バトルリサーチ（AI＋動画発掘）の復元・コーチ画面直接統合 ＆ チャンピオン辞典への一発同期機能の実装
