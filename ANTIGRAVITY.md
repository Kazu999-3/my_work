...
- [ ] **[フェーズ14]** 攻略ナレッジ統合ハブ ＆ ノイズレス・ゼロ遷移UI再設計 [NOW]
  - [ ] **[ステップ1]** ナレッジ情報設計の統合（/champions, /lane-guides, /admin/knowledge, /admin/dict-health の集約設計）
  - [ ] **[ステップ2]** 2ペイン式（マスター・詳細）ゼロ遷移ワークスペースUIの実装
  - [ ] **[ステップ3]** コンテキスト連動アクション（AIファクトチェック・最新メタ更新・対面メモ・履歴）のインライン統合
  - [ ] **[ステップ4]** サイドバー＆ボトムナビの全ページナビゲーション階層スリム化
