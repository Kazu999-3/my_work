...
| スキル名 | ファイルリンク | 役割と目的 |
| :--- | :--- | :--- |
| **SNSバズスレッド生成** | [SNSTweetThreadGenerator.md](./03_promotion_automation/SNSTweetThreadGenerator.md) | 長文コンテンツから、X（Twitter）でクリック率の高い「5連スレッド（ツリー投稿）」を自動生成する。 |
...
特定ジャンル（LoL）の深いペインポイント（悩み）をハックし、圧倒的価値を提供することで読者をファン化・収益化へ導く専門コーチ群です。
